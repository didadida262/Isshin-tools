...
"""Douyin a_bogus signer (vendored). Pure-Python SM3, no gmssl dependency."""
from __future__ import annotations

# ---- pure SM3 (GM/T 0004-2012), gmssl-compatible surface ----
class _SM3Func:
    @staticmethod
    def bytes_to_list(data: bytes):
        return list(data)
...
class _SM3Mod:
    sm3_hash = staticmethod(_sm3_hash)
...
if __name__ == "__main__":
    ...
    if isinstance(params, str):
        ...
        value = ABogus().get_value(params)
    else:
        value = ABogus().get_value(params)
    sys.stdout.write(quote(value, safe=""))
